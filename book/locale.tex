...
\titlecontents{chapter}[0em]{\addvspace{1.5ex}\bfseries}{\prechaptername\CJKnumber{\thecontentslabel}\postchaptername\quad}{\hspace*{-0.0em}}{\hfill{}\contentspage}[\addvspace{0.5ex}]
